...
(content propagation) from post content
...
def get_args():
    ...
    parser.add_argument('--data-dirpath', dest='data_dirpath', nargs='?', help='data dirpath; default /data/tumblr_community_identity/dataset114k', default='/data/tumblr_community_identity/dataset114k')
    ...
    parser.add_argument('--output-dirpath', dest='output_dirpath', nargs='?', help='The output dirpath will be named ``output'' inside of this parent directory. Default is /projects/tumblr_community_identity', default='/projects/websci2020_tumblr_identity')
    parser.add_argument('--categories', dest='categories', nargs='?', help='default all single categories + all together', default='all+all')
    parser.add_argument('--feature-selection', dest='feature_selection_k', nargs='?', type=int, help='Number of features to select if doing feature selection. If not, put -1. Default -1', default='-1')
...
def main():
    ...
    X_train, y_train, X_test, y_test, baseline_X, features_vectorizer = extract_features(
            ['post_baseline'], 
            instances, 
            instance_labels, 
            identity_categories, 
